# @halostatue/fish-macports/conf.d/halostatue_fish_macports.fish:v1.1.1

function _halostatue_fish_macports_setup
...
_halostatue_fish_macports_setup
functions -e _halostatue_fish_macports_setup

function _halostatue_fish_macports_uninstall -e halostatue_fish_macports_uninstall
end
